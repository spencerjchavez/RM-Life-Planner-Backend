...
from app.testing.test_scripts.goal_achieving_tests.GoalAchievingTest import GoalAchievingEndpointsTest
from app.testing.test_scripts.calendar_item_tests.CalendarEndpointsTest import CalendarEndpointsTest
