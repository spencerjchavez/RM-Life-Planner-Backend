...
drop table desire_category_ids_by_user;
create table desire_category_ids_by_user(
user_id int unsigned primary key not null,
category_ids varbinary(120)
);

drop table desire_categories;
create table desire_categories(
